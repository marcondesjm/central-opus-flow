  ...
  return <section className="py-16 md:py-24 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {audiences.map((audience, index) => <motion.div key={audience.title} className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-lg transition-all" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          delay: index * 0.1
              ...
              <ul className="space-y-2">
                {audience.benefits.map((benefit, i) => <li key={i} className="flex items-center justify-center gap-2 text-sm">
