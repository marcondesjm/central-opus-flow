          ...
          <div className="rounded-2xl bg-card border border-border/50 overflow-hidden shadow-2xl shadow-black/20">
            ...
            <div className="p-4 md:p-6 bg-background">
              ...
              <div className="grid grid-cols-5 gap-3 mb-6">
                {stats.map((stat, i) => (
                  <div key={i} className="bg-card border border-border/40 rounded-xl p-3 md:p-4">
                  ...
                  >
                    <div className={`h-28 md:h-32 bg-gradient-to-br ${project.gradient} relative`}>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <p className="text-white/90 text-xs md:text-sm font-bold text-center px-3">{project.name}</p>
                      </div>
                    </div>
