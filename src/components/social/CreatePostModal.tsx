...
import { CalendarIcon, Clock, Hash, Send, Save } from 'lucide-react';
import { format } from 'date-fns';
import { ptBR } from 'date-fns/locale';
import { cn } from '@/lib/utils';
import { useCreateSocialPost, useSocialAccounts } from '@/hooks/useSocialMedia';
...
export function CreatePostModal({ open, onOpenChange }: Props) {
  ...
  const resetForm = () => {
    setTitle(''); setContent(''); setPlatform('instagram'); setPostType('feed');
    setAccountId(''); setDate(undefined); setTime('12:00'); setHashtags(''); setNotes('');
  };
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea value={content} onChange={e => setContent(e.target.value)} placeholder="Escreva a legenda do post..." rows={4} />
          </div>
