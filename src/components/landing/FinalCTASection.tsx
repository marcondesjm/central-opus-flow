...
export function FinalCTASection() {
  return (
    <section className="py-24 md:py-32 px-4 relative overflow-hidden bg-muted/20 border-t border-border/30">
      ...
      <div className="container mx-auto max-w-2xl relative">
        ...
        >
          <h2 className="text-3xl md:text-[2.75rem] font-bold mb-5 tracking-[-0.02em] leading-tight">
            Comece a organizar
            <br />
            <span className="text-primary">seus projetos hoje</span>
          </h2>
